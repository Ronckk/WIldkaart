// Hertenpagina (herten.html): kaart, statistieken, verwachting en hotspots; de cijfers komen uit assets/site.js (WDK).
(function(){
  // De plaatsen worden in assets/site.js uit de gebeurtenissen (`ev`) berekend.
  var LOADED = WDK.load('hert');
  ...
  WDK.renderForecast(document.getElementById('forecastCard'), { species:'hert', rows:LOADED.veluwe, scope:'veluwe', updatedAt:LOADED.updatedAt });
